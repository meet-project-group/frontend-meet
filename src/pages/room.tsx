...
export default function Room() {
  ...
  // 3️⃣ 🔥 REENVIAR LA CÁMARA A TODOS (CLAVE)
  if (!videoStream || !peerRef.current) return;

  Object.keys(remoteStreams).forEach((peerId) => {
    peerRef.current.call(peerId, videoStream, {
